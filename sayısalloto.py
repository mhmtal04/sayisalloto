...
st.markdown("""
    <style>
    .result-row { display: flex; flex-wrap: wrap; gap: 8px; margin: 10px 0 25px 0; }
    .result-item {
        padding: 10px 15px; border-radius: 5px; font-family: sans-serif;
        font-weight: 600; font-size: 16px; border: 1px solid rgba(28, 131, 225, 0.1);
        display: flex; align-items: center; min-width: 100px; justify-content: center;
    }
